# -*- coding: utf-8 -*-
"""Copy of week6_final_project_image_captioning_clean.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PnTYqF8V0hAPhNbdX3M24tc-6MygOggt
...
class decoder:
    ...
    '''
    for token in flat_ground_truth:
        if token != pad_idx:
            flat_loss_mask = tf.constant(1.0)
        else:
            flat_loss_mask = tf.constant(0.0)
    '''
